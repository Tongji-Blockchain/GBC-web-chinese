<?php 
$pageTitle='Technical Program'; //THIS MUST BE SET FOR EACH PAGE
...
敬请期待
	...
	More than 500 articles were submitted for review to the CCTA 2017.  Submissions were received from 38 countries. With roughly one third of submissions from North America, one third from the Pacific Rim, and one third from Europe, CCTA 2017 is a truly international event. The complete Technical Program will be posted when the review process and program construction is complete; please check back to this page frequently.  

	<br><br>

	Chairs of technical sessions in the program of CCTA 2017 are a critical component of the conference success.  If you are interested in being considered for service as a Session Chair or co-Chair at CCTA 2017, please <a style="color:red" href="session-chairs.php">click here</a>.
	<br><br>

	The Technical Program will consist of contributed articles as well as articles included in proposed thematic invited sessions. All articles, whether contributed (submitted at large) or invited, were subject to the standard process for IEEE article peer review.  A special industry-academia Panel Session will be held on Monday evening, 6:15PM to 7:45PM, in the Hale Hoaloha Pavilion; please <a href="panel-session.php" style="color:red">click here</a> for more information.
